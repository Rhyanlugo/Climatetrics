export default function SidePanel({
  ...
  return (
    <div className="col-span-1 grid grid-rows-6 rounded-lg bg-gray-400 p-4 ">
      <div
        className={`row-span-1 flex items-center justify-center rounded-xl ${bgColorTop} text-4xl font-bold text-white shadow-md`}
      >
        <h2>{country}</h2>
      </div>
      <div
        className={`row-span-5 mt-2 rounded-xl ${bgColorBottom} p-4 shadow-lg`}
      >
...
function SidePanelBox({ tracking, value }) {
  return (
    <div className="mb-4 grid grid-rows-2 justify-center rounded-lg border-black bg-gray-500 text-center shadow-md">
